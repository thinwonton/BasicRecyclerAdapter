 ...
 */
public class HeaderFooterLinearAdapter extends HeaderFooterMultipleTypeAdapter<Cat, MultipleLinearViewHolder> {
    private final String TAG = "HeaderFooterLinearAdapter";
